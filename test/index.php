        ...
        <table width="728" border="1">
            <tr>
                ...
                <td width="169"><label for="textfield"></label>
                    <input type="text" name="so_dau" id="textfield"
                        value="<?php if (isset($_POST["so_dau"])) echo $_POST["so_dau"]; ?> " />
                </td>
                <td width="152">Số kết thúc</td>
                <td width="175"><label for="textfield2"></label>
                    <input type="text" name="so_cuoi" id="textfield2"
                        value="<?php if (isset($_POST["so_cuoi"])) echo $_POST["so_cuoi"]; ?> " />
                </td>
            </tr>
            <tr>
